...
def getPrivateKey():
    with open('../\\files_stored_in_candidates2_encrypted_USB\\can2_private_key.txt') as f:
        lines = f.readlines()
...
def generateA(G):
    ...
    with open('can2_ECC_PG.txt', 'r') as f:
        lines = f.readlines()
    ...
    while True:
        ...
        for partition in psutil.disk_partitions():
            ...
            if 'removable' in partition.opts:
                ...
                key_file_path = os.path.join(drive_path, 'can2_private_key.txt')
