...
def getPrivateKey():
    with open('../\\files_stored_in_candidates3_encrypted_USB\\can3_private_key.txt') as f:
        lines = f.readlines()
...
def generateA(G):
    ...
    with open('can3_ECC_PG.txt', 'r') as f:
        lines = f.readlines()
    ...
    while True:
        ...
        for partition in psutil.disk_partitions():
            ...
            if 'removable' in partition.opts:
                ...
                key_file_path = os.path.join(drive_path, 'can3_private_key.txt')
